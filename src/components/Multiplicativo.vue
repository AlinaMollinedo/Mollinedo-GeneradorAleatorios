...
const calc = () => {
    ...
    g.value = Math.ceil((Math.log10(P.value) / Math.log10(2)) + 2)
    m.value = Math.pow(2, g.value)
    a.value = (ca.value == 1) ? 3 + 8 * k.value : 5 + 8 * k.value
    ...
    for(let i = 1; i <= P.value; i++){
        xi.value.push((a.value * xi.value.at(i - 1)) % m.value)
        ...
        <v-row class="mt-5">
            ...
            <v-col cols="12" sm="4">
                ...
                :rules="[
                    ...
                    v => v % 2 != 0 || 'La semilla debe ser un número impar'
                ]"
                required
                />  
            </v-col>
            ...
            <v-table class="elevation-1" striped="even">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="table-content">({{ a }} * {{ xi.at(i - 1) }}) MOD({{ m }})</td>
